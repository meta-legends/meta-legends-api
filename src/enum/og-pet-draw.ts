...
export const SUPPLY_PET_ROUGH_TIERS_1 = 106;
export const SUPPLY_PET_ROUGH_TIERS_2 = 85;
export const SUPPLY_PET_ROUGH_TIERS_3 = 53;
export const SUPPLY_PET_CYBER_TIERS_1 = 96;
export const SUPPLY_PET_CYBER_TIERS_2 = 75;
export const SUPPLY_PET_CYBER_TIERS_3 = 43;
export const SUPPLY_PET_MATRIX_TIERS_1 = 85;
export const SUPPLY_PET_MATRIX_TIERS_2 = 64;
export const SUPPLY_PET_MATRIX_TIERS_3 = 32;
export const SUPPLY_PET_GOLDBOI_TIERS_1 = 75;
export const SUPPLY_PET_GOLDBOI_TIERS_2 = 42;
export const SUPPLY_PET_GOLDBOI_TIERS_3 = 21;
export const SUPPLY_PET_ROBOTER_TIERS_1 = 53;
export const SUPPLY_PET_ROBOTER_TIERS_2 = 42;
export const SUPPLY_PET_ROBOTER_TIERS_3 = 21;
export const SUPPLY_PET_BURNER_TIERS_1 = 53;
export const SUPPLY_PET_BURNER_TIERS_2 = 26;
export const SUPPLY_PET_BURNER_TIERS_3 = 15;
...
export const SPECIFIC_PET_FOR_WHALE = 'whale';
...
export const SUPPLY_PET_WHALE = 26;
...
export const SPECIFIC_NAME_PET_WHALE = 'Gold Celestial Falcoz';
...
export const OG_PET_SPECIFIC_SUPPLY = [
  ...
  {
    for: SPECIFIC_PET_FOR_WHALE,
    pet: SPECIFIC_NAME_PET_WHALE,
    supply: SUPPLY_PET_WHALE,
