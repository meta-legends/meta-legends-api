...
export const VEHICLE_CELESTIAL_REG_NAME = 'Speedster';
...
export const VEHICLE_BURNER_REG_NAME = 'Speed Tank';
...
export const VEHICLE_ROBOTER_REG_NAME = 'HoverTank';
...
export const VEHICLE_GOLDBOI_REG_NAME = 'Tank';
...
export const VEHICLE_MATRIX_REG_NAME = 'Racing Car';
