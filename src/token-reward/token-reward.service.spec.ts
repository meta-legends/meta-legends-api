...
import {
    PERK_LABEL_ARMOR, PERK_LABEL_LAND,
    PERK_LABEL_PET, PERK_LABEL_RESIDENCE, PERK_LABEL_VEHICLE,
    PERK_RATIO_REWARD_ARMOR, PERK_RATIO_REWARD_LAND,
    PERK_RATIO_REWARD_PET, PERK_RATIO_REWARD_RESIDENCE, PERK_RATIO_REWARD_VEHICLE, REWARD_RATIOS,
    TokenRewardService
...
describe('TokenRewardService', () => {
    ...
    it('should estimate token rewards by package', () => {
        ...
        expect(service.estimate(mintArmorPackage, new Date('2022-01-01'))).toEqual(1.47);
        // armor package: days 39
        mintArmorPackage.pricePaidEth = 0.9;
        expect(service.estimate(mintArmorPackage, new Date('2022-02-02'))).toEqual(8.19);
        ...
        expect(service.estimate(mintLandPackage, new Date('2023-04-07'))).toEqual(13137.24);
    });
    ...
    it('should get REWARD RATIO by perk label', () => {
        ...
        expect(service.getRewardRatiosByPerkLabel(PERK_LABEL_ARMOR)).toEqual(expectedArmor);
        ...
        expect(service.getRewardRatiosByPerkLabel(PERK_LABEL_LAND)).toEqual(expectedLand);
        ...
        expect(service.getRewardRatiosByPerkLabel(PERK_LABEL_PET)).toEqual(expectedPet);
    ...
    it('should estimate token rewards by no perk', () => {
        ...
        expect(service.getPerkPackages([mintPackage], new Date())).toEqual(expected);
    });
    it('should estimate armor perk', () => {
        ...
        expect(service.getPerkPackages([mintPackage], new Date('2023-04-07'))).toEqual(expected);
    });
